...
import (
	...
	"github.com/manueldembo/clean_architecture/configs"
	"github.com/manueldembo/clean_architecture/internal/event/handler"
	"github.com/manueldembo/clean_architecture/internal/infra/graph"
	"github.com/manueldembo/clean_architecture/internal/infra/grpc/pb"
	"github.com/manueldembo/clean_architecture/internal/infra/grpc/service"
	"github.com/manueldembo/clean_architecture/internal/infra/web/webserver"
...
func getRabbitMQChannel(rabbitMQHost string) *amqp.Channel {
	strConn := fmt.Sprintf("amqp://guest:guest@%s:5672/", rabbitMQHost)
